...
public class FitManager {
    ...
    public OperationResult<Enrollment> cancelEnrollment(int code, String reason) { return enrollmentService.cancel(code, reason); }

    public OperationResult<Double> calculateCancelationFee(int code) { return enrollmentService.calculateCancelationFee(code); }
